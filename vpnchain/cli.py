...
def build_parser() -> argparse.ArgumentParser:
    ...
    add.add_argument('--server-public-key', default=None, help='Server public key to embed into generated client config; defaults to VPNCHAIN_SERVER_PUBLIC_KEY')
    add.add_argument('--server-endpoint', default=None, help='Server endpoint HOST:PORT to embed into generated client config; defaults to VPNCHAIN_SERVER_ENDPOINT')
