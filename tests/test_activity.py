...
def test_parse_wg_dump_peer_lines():
    dump = """server-private\tserver-public\t51820\toff\npeerpub1\t(none)\t203.0.113.9:2222\t10.8.0.3/32\t1710000000\t1234\t5678\t25\npeerpub2\t(none)\t(none)\t10.8.0.4/32\t0\t0\t0\toff\n"""
...
def test_merge_peer_activity_unknown_gracefully():
    ...
    activity = parse_wg_dump('peerpub1\t(none)\t198.51.100.5:1\t10.8.0.3/32\t1710000000\t10\t20\t25\n')
